...
| 2 | Skill assignments + notifications | ✅ | 8a2f505, lesson-48 | 2026-01-13 | skill_assignments table + RLS + mentor_notifications table implemented and wired; MentorSkills reads notifications from DB; StudentSkills inserts notifications to DB; localStorage flows removed; manual: Mentor dashboard -> Skills -> Assign; Student dashboard -> Skills -> Mark Completed -> Mentor sees notification |
