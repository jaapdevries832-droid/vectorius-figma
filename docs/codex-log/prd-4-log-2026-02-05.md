...
### Changes
- [ ] Migration: Create student_enrolled_courses view
- [ ] Frontend: Update AssignmentsPage.tsx to use new view
...
### Changes
- [ ] Frontend: Add localStorage persistence to ChatInterface.tsx
- [ ] Frontend: Add Clear Chat button
